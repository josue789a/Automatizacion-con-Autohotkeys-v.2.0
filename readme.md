...
- **Zonas de activación calibradas por DPI.** Los puntos calibrados corresponden a coordenadas de pantalla que disparan acciones específicas, calibradas con conciencia de escalado de Windows para no desalinearse entre monitores de distinta resolución.
